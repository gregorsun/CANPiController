# 1 "interrupt_handler_function.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "interrupt_handler_function.c" 2
# 24 "interrupt_handler_function.c"
...
# 24 "interrupt_handler_function.c" 2

# 1 "./interrupt_handler_function.h" 1
# 15 "./interrupt_handler_function.h"
void TU16A__C1_TransmitInterruptHandler(void);
void C1__ReceiveFIFO1NotEmptyHandler(void);
# 25 "interrupt_handler_function.c" 2
...
# 26 "interrupt_handler_function.c" 2
...
# 27 "interrupt_handler_function.c" 2
...
void C1__ReceiveFIFO1NotEmptyHandler(void){
    ...
    while(1)
    {
        ...
        {
            if(1 == CAN1_ReceiveFrom(FIFO1,&Currently_Processing))
            {
                break;
            }
        }
